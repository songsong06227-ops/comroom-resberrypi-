...
# =============================
HR_buffer = []
HR_BUFFER_SIZE = 3     # 최근 3개 이동평균
HR_JUMP_LIMIT = 25     # HR 급변 허용 폭
...
# 7) 수면 예측 (γ 제거 버전)
# =============================
def predict_sleep_time(drink_log, HALF_LIFE_HOURS, R_now, alpha, beta):
    ...
    dt = 300                    # 5분 단위
    future_hours = 24           # 24시간 예측
    R = R_now
    t_now = time.time()

    lambda_decay = 0.15         # 자연 감소율
